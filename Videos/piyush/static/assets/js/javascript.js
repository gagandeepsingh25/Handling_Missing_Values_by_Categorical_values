    ...
    document.getElementById('autoResizeTextarea').addEventListener('keypress', function(event) {
        keyPressCount++;
        if (keyPressCount === 1) {
    ...
    document.getElementById('autoResizeTextarea').addEventListener('submit', handleSubmit);
    ...
    document.getElementById('send-button').addEventListener('click', function(event) {
        ...
        // Get the user input
        var userInput = document.getElementById("autoResizeTextarea").value.trim();
    ...
    function sendMessage() {
        ...
        document.getElementById("autoResizeTextarea").value = "";
    ...
    function displayAllResponses() {
        ...
        // Only append the last response
        var lastResponse = responses[responses.length - 1];
        appendChatbotResponse(lastResponse);
    }
    ...
    function toggleButtons(isSending) {
      ...
      function createUserChatElement(text) {
        ...
        innerDiv1.className = 'px-4 py-2 justify-center text-base md:gap-6 container-maxW890 m-auto user-msg';
        const innerDiv2 = document.createElement('div');
        innerDiv2.className = 'flex flex-1 text-base mx-auto gap-3 md:px-5 lg:px-1 xl:px-5 md:max-w-3xl group ai-out';
...
async function appendChatbotResponse(responseList) {
console.log(responseList,'aaaaaaaaa')
    const chatContainer = document.getElementById("chat-container");
    const mainDiv = document.createElement('div');
    mainDiv.className = 'w-full py-0 text-token-text-primary m-auto container-maxW890 ai-chat';
    mainDiv.style = '--avatar-color: #19c37d;';
    const innerDiv1 = document.createElement('div');
...
//    innerImg.setAttribute('src', 'https://img.freepik.com/premium-vector/sa-letter-logo-design-black-background-initial-monogram-letter-sa-logo-design-vector-template_634196-1071.jpg');
    innerImg.setAttribute('src', '/static/assets/img/main_img/intel.png');
    ...
    const secondInnerDiv2 = document.createElement('div');
    secondInnerDiv2.className = 'font-semibold select-none';
    secondInnerDiv2.textContent  = 'Intel';
    const secondInnerDiv3 = document.createElement('div');
    secondInnerDiv3.className = 'flex-col gap-1 md:gap-3';
    const secondInnerDiv4 = document.createElement('div');
    secondInnerDiv4.className = 'flex flex-grow flex-col max-w-full';
