(function () {
    ...
    const apiUrl = '/user-suggestions-chatbot/'; // Update this URL to your Django view URL
  
    function fetchSuggestions(query, group_id=0, callback) {
      $.ajax({
        url: apiUrl,
    ...
    TagifyUserList.on('input', function (e) {
      const Group_id = document.getElementById('selectedChatbot_id').value;
