  ...
  (function () {
    ...
    if (emailEditor) {
      new Quill('.email-editor', {
        ...
        placeholder: 'Write the description of the file... ',
        theme: 'snow'
      });
    }
    ...
    emailFilterByFolders.forEach(emailFilterByFolder => {
      emailFilterByFolder.addEventListener('click', e => {
        ...
        const qa_button = document.querySelector('#qa-button')
        ...
        emailListItems.forEach(emailListItem => {
          ...
          if (currentTargetData == 'inbox') {
            ...
            upload_button.classList.add('d-block');
            upload_button.classList.remove('d-none');
            website_button.classList.add('d-none');
            website_button.classList.remove('d-block');
          } 
          ...
          if (currentTargetData == 'starred') {
            upload_button.classList.add('d-none');
            upload_button.classList.remove('d-block');
            website_button.classList.add('d-block');
            website_button.classList.remove('d-none');
            qa_button.classList.add('d-none');
            qa_button.classList.remove('d-block');
          }
          else if (currentTargetData == 'sent') {
            upload_button.classList.add('d-block');
            upload_button.classList.remove('d-none');
            website_button.classList.add('d-none');
            website_button.classList.remove('d-block');
          ...
          else if (currentTargetData == 'draft') {
            
            qa_button.classList.add('d-block');
            qa_button.classList.remove('d-none');
            upload_button.classList.add('d-none');
            upload_button.classList.remove('d-block');
            website_button.classList.add('d-none');
            website_button.classList.remove('d-block');
