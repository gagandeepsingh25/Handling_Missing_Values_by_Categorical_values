...
(function () {
    ...
    const messages_per_day = JSON.parse(data.messages_per_day)
    const visitors_by_os = JSON.parse(data.visitors_by_os.replaceAll("'", '"'))
    const visitors_by_browser = JSON.parse(data.visitors_by_browser.replaceAll("'", '"'))
    const visitors_by_device = JSON.parse(data.visitors_by_device.replaceAll("'", '"'))
    console.log("messages_per_day: ", messages_per_day)
    console.log("visitors_by_os: ", visitors_by_os)
    console.log("visitors_by_browser: ", visitors_by_browser)
    console.log("visitors_by_device: ", visitors_by_device)
    ...
    // --------------------------------------------------------------------
    const visitorByBrowserDonutChartEl = document.querySelector('#visitorByBrowserChat'),
    ...
    // --------------------------------------------------------------------
    const visitorByOSDonutChartEl = document.querySelector('#visitorByOS'),
